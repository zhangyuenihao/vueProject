<template>
    <div class="goods-item" @click="itemClick">
            <img class="goodsListItem-img" v-lazy="showImage" alt="" @load="itemImageLoad">
...
<script>
    export default {
        ...
        computed:{
            showImage(){
                return this.goodsListItem.image?this.goodsListItem.image:this.goodsListItem.show.img
            }
        }
    }
</script>
